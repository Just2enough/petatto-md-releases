...
**Unsupported** elements (images, code blocks, tables, blockquotes, horizontal rules, etc.) are shown as plain text (no crash). For the intentionally out-of-scope areas, see [Non-Goals](non_goals.en.md).
